  ...
  return (
    <main className="flex flex-col items-center min-h-screen w-screen p-12">
      ...
      <div className="flex flex-col w-[90%] md:w-[50%] pt-12 text-xl">
        ...
        <p>API available at <Link className="hover:cursor-pointer hover:underline" href="https://api.tidytube.app" target="_blank">api.tidytube.app</Link> but only some routes are public. API docs available <Link className="hover:cursor-pointer hover:underline" href="https://github.com/kakajuro/tidytube-backend/wiki/API-Documentation" passHref target="_blank">here</Link>.</p>
      </div>
