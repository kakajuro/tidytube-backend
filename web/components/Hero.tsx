    ...
    <section className="flex flex-col w-screen min-h-screen items-center justify-center pt-12 overflow-hidden select-none text-center">
      ...
      <div className="flex flex-row justify-evenly items-center pt-10 h-8 w-[80%] sm:w-[60%] md:w-[50%] lg:w-[40%]">
        ...
        <BlurFade delay={baseDelayIcons + 0.4} duration={0.2} inline={false}>
          <FaOpera className="hover:cursor-pointer hover:text-red-600 hover:-translate-y-1 duration-500 transition-all ease-in-out" size={35} title="Opera Extension Download" />
        </BlurFade>
      </div>
    </section>
  )
