...
export const privacyOpening = `tidytube is an extension that provides extra customisation options to the Youtube UI. Please read this fully so you understand exactly how your data is stored and processed. This will be updated if there are any changes.`

export const serverOne = `-A hashed version of your clientID which is randomly generated along side what install number you were, a timestamp of when you installed the extension and a hashed version of your uninstall key (the uninstall key is used to remove this data when you uninstall the extension).`